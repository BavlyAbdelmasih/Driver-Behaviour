...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Name = LoginIntent.getStringExtra("userid");// creating list to add score
    ...
    private String getDirectionsUrl() {
        ...
        googleDirectionsUrl.append("&key=" + "AIzaSyA6oaiL31TLvudvEwip726B-4Syxuz23E0");
...
//        Toast.makeText(MapsActivity.this, "Your Current Location", Toast.LENGTH_LONG).show();
      ...
      /*  if (mGoogleApiClient != null) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(com.android.volley.Request.Method.GET, "https://roads.googleapis.com/v1/speedLimits?path=" + location.getLatitude() + "," + location.getLongitude() + "&key=AIzaSyA6oaiL31TLvudvEwip726B-4Syxuz23E0", null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
