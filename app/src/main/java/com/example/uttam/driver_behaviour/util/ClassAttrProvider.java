package com.example.uttam.driver_behaviour.util;

import android.content.res.AssetManager;
import android.graphics.Color;

import com.example.uttam.driver_behaviour.Config;
...
public final class ClassAttrProvider {
    ...
    private void init(final AssetManager assetManager) {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(assetManager.open("assets/")))) {
            String line;
